...
class Logger:
    ...
    def __new__(cls, debug: bool = DEBUG):
        if cls._instance is None:
            ...
            cls._instance.full_logger.setLevel(
                logging.DEBUG if cls._instance.debug else logging.INFO)
    ...
    def log_or_print(self, msg: str, level: str = "INFO", exc_info: bool = False, module: str = None):
        try:
            ...
            if len(msg) > 1000:
                ...
                # Log the full message in the second log file
                self.full_logger.log(log_level_value, f"{log_id} - {msg}")
            else:
                truncated_msg = msg
...
if __name__ == "__main__":
    ...
    logger.log_or_print("This is a very long message, designed primarily to test whether the log message truncation feature is working as expected.",
                        level="DEBUG", module="TestModule")
