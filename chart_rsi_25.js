        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function extractDataFromRSI25Table() {
                const table = document.querySelector('div.table-container .rsi_25_ScrollableTable table');
        ...
        zoomType: 'xy',
                ...
                yAxis: [{
                    ...
                    plotLines: [{
                        value: Math.max(...rsi_25_Data.candlestick.map(point => point[2])),  // 52-week high
                        ...
                        value: Math.min(...rsi_25_Data.candlestick.map(point => point[3])),  // 52-week low
