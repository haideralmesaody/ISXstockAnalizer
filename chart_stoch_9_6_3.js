function extractDataFromSTOCHTable() {
  const table = document.querySelector(
    "div.table-container .stoch_9_6_3_ScrollableTable table"
  );
...
document
  .getElementById("STOCH_9_6_3Button")
      ...
      yAxis: [
        {
          ...
          plotLines: [
            {
              value: Math.max(
                ...stoch_Data.candlestick.map((point) => point[2])
              ),
              color: "#FF4136",
              dashStyle: "ShortDash",
              width: 1,
            ...
            {
              value: Math.min(
                ...stoch_Data.candlestick.map((point) => point[3])
              ),
              color: "#3D9970",
              dashStyle: "ShortDash",
              width: 1,
